...
public class EnergyCheckUtils {
	...
	public static void main(String[] args) {
		...
		for(int i= 0; i < 10; i++){
			...
			UmCarroJaApp.lerDadosTXT("logs4.txt");
		...
		for(int i= 0; i < 10; i++){
			...
			try {
				...
				Veiculo v1 = new Veiculo("Ford","AZ-12-12","1",90,3.45,1.3,100,new Coordinate(1,1),true);
				Veiculo v2 = new Veiculo("Mercedes","LO-34-01","1",110,3.70,1.9,120,new Coordinate(13.2,1),true);
			...
			}catch(UtilizadorJaExisteException | UtilizadorNaoExisteException | VeiculoJaExisteException |
					PasswordIncorretaException | NaoExistemVeiculosDisponiveisException e){
