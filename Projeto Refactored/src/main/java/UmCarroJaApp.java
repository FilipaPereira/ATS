...
public class UmCarroJaApp{
    ...
    private static void iniciarSessao(String email, String password) {
        try{
    ...
    private static void registarProprietario(String nome, String nif, String email, String password, 
        ...
        try {
            ...
            out.println("O proprietário " + e.getMessage() +  " já esta registado!\n");
        }
    }
    ...
    private static void registarVeiculoProp(){
       ...
       while(existe){
        ...
        try {
            ...
            out.println(car + e.getMessage() +  " já está registado!\n");
        }
    }   
    ...
    private static boolean verificaData (GregorianCalendar inicio, GregorianCalendar fim){
        return ((inicio.equals(dataInicioApp) || inicio.after(dataInicioApp)) &&
    ...
    private static void aluguerMaisProximo(){
        ...
        out.print("Digite o Número de Veículos Mais Proximos que Deseja Listar: ");
        ...
        do{
            out.print("Introduza a Matrícula do Veiculo que Pretende Alugar: ");
            matricula = Input.lerString(errorMatricula, insertMatriculaAgain);
    ...
    private static void lerDadosTXT(String fichtxt) throws IOException {
