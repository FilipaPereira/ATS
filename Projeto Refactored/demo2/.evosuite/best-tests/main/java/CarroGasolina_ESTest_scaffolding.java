...
public class CarroGasolina_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "main.java.CarroGasolina"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("main.java.Coordinate", false, CarroGasolina_ESTest_scaffolding.class.getClassLoader()));
  }
