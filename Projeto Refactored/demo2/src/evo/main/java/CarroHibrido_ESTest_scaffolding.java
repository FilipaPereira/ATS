...
public class CarroHibrido_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "main.java.CarroHibrido"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("main.java.Coordinate", false, CarroHibrido_ESTest_scaffolding.class.getClassLoader()));
  }
