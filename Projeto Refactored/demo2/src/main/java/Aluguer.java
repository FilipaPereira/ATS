...
public class Aluguer implements Serializable {
     ...
     */
    public Aluguer(String mail, String matricula, GregorianCalendar inicio, GregorianCalendar fim,Coordinate dest){
        this.mail = mail;
    ...
    public void setTempoAteVeiculo(int tempoAteVeiculo){this.tempoAteVeiculo = tempoAteVeiculo;}
